...
class ToastNotification:
    ...
    def show(self, message, title="Notification", duration=3000, style="info"):
        ...
        self.toast_queue.append({"message": message, "title": title, "duration": duration, "style": style})
        self._process_queue()
    ...
    def _create_toast(self, message, title, duration, style):
        ...
        toast.geometry(
            "350x100+{}+{}".format(
                self.parent.winfo_x() + self.parent.winfo_width() - 370, self.parent.winfo_y() + 50
            )
        )
        ...
        colors = {"info": "#d1ecf1", "success": "#d4edda", "warning": "#fff3cd", "danger": "#f8d7da"}
        ...
        # Title
        title_label = tk.Label(content, text=title, font=("Segoe UI", 10, "bold"), bg=bg_color, fg="#000000")
        title_label.pack(anchor="w", padx=15, pady=(10, 0))

        # Message
        message_label = tk.Label(
            content, text=message, font=("Segoe UI", 9), bg=bg_color, fg="#000000", wraplength=300
        )
