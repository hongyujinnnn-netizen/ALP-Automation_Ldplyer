...
class SidebarMixin:
    def create_sidebar(self, parent):
        ...
        nav_items = [
            ...
            ("backups", "Backups", self.show_backup_manager, "CONTROL", ""),
            ("queue", "Task Queue", lambda: self.notebook.select(7), "CONTROL", "0"),
            ("schedule", "Scheduler", lambda: self.notebook.select(6), "MANAGE", ""),
            ("logs", "Logs", lambda: self.notebook.select(8), "SYSTEM", ""),
