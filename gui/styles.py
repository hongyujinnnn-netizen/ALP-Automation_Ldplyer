...
def configure_styles(root, style, palette, display_font, mono_font, appearance=None):
    ...
    style.configure("TLabelframe", borderwidth=0, relief="flat", background=palette["surface"])
    style.configure(
        "TLabelframe.Label",
    ...
    style.configure(
        "SidebarTitle.TLabel",
        font=(display_font, f("sidebar_title", 14)),
        foreground=palette["text"],
        background=palette["surface"],
    )
    style.configure(
    ...
    style.configure(
        "TopTitle.TLabel",
        font=(display_font, f("top_title", 15)),
        foreground=palette["text"],
        background=palette["surface"],
    )
    style.configure(
    ...
    style.configure(
        "Nav.TButton", font=(display_font, f("button", 10)), anchor="w", padding=s("nav_pad", (10, 8))
    )
    style.map(
        "Nav.TButton",
    ...
    style.configure(
        "NavActive.TButton", font=(display_font, f("button", 10)), anchor="w", padding=s("nav_pad", (10, 8))
    )
    style.configure(
    ...
    style.configure(
        "MetricLabel.TLabel",
        font=(display_font, f("small", 8)),
        foreground=palette["muted"],
        background=palette["surface"],
    )
    style.configure(
        "MetricValue.TLabel",
        font=(mono_font, f("metric", 28)),
        foreground=palette["text"],
        background=palette["surface"],
    )
    style.configure(
    ...
    style.configure(
        "TNotebook.Tab", padding=s("notebook_tab_pad", (16, 11)), font=(display_font, f("body", 10))
    )
    style.map(
        "TNotebook.Tab",
    ...
    style.configure("Title.TLabel", font=(display_font, f("title", 18)), foreground=palette["text"])

    style.configure("Subtitle.TLabel", font=(mono_font, f("subtitle", 10)), foreground=palette["muted"])
    style.configure("SectionTitle.TLabel", font=(display_font, f("section", 16)), foreground=palette["text"])
    style.configure(
    ...
    style.configure("HeroTitle.TLabel", font=(display_font, f("hero", 21)), foreground=palette["text"])
    style.configure("HeroSub.TLabel", font=(mono_font, f("subtitle", 10)), foreground=palette["muted"])
    style.configure("Chip.TLabel", font=(display_font, f("meta", 9)), foreground=palette["text"])
    style.configure(
        "StatusPill.TLabel",
        font=(display_font, f("meta", 9)),
        foreground=palette["text"],
